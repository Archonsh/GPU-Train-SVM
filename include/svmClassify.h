 ...
 * @param gpuId specifies which gpu to use for classification
 */
void performClassification(float *data, int nData, float *supportVectors, int nSV, int nDimension, float* alpha, Kernel_params kp, float** p_result, int gpuId = -1);
